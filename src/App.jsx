...
export default function App() {
  ...
  if (view === "confidentialite") return (
    <LegalPage title="Politique de confidentialité">
      ...
      <LP>• <strong>Hébergeur du site</strong> : [à compléter] — données d'hébergement<br/>• <strong>Service de messagerie</strong> : [à compléter selon le choix — ex. : OVH, Google Workspace] — données de contact</LP>
      ...
      <LH>8. Sécurité</LH>
      <LP>RGPD Express met en œuvre les mesures techniques et organisationnelles appropriées pour protéger les données personnelles contre tout accès non autorisé, toute perte, toute altération ou toute divulgation, notamment : chiffrement des communications (protocole HTTPS/TLS), hébergement sur des serveurs situés en France, accès restreint aux données par authentification sécurisée.</LP>

      <LH>9. Transferts hors Union européenne</LH>
      <LP>RGPD Express s'engage à ne pas transférer de données personnelles vers des pays situés en dehors de l'Union européenne, sauf dans le cadre de garanties appropriées conformes au RGPD (clauses contractuelles types, décision d'adéquation).</LP>
      ...
      <div style={{ fontFamily: FB, minHeight: "100vh", background: "#fff" }}>
        ...
        <div style={{ maxWidth: 620, margin: "0 auto", padding: "28px 24px 60px" }}>
          ...
          <div style={{ background: "linear-gradient(135deg, #2563eb08, #3b82f608)", borderRadius: 20, border: "1.5px solid #2563eb20", padding: "30px 24px", marginBottom: 20, textAlign: "center" }}>
            ...
            <a href={`mailto:${EMAIL}?subject=Demande de mise en conformité RGPD`} style={{
            ...
            <p style={{ fontSize: 10, color: "#94a3b8", marginTop: 10 }}>Hébergé en France 🇫🇷 · Accompagnement inclus</p>
          </div>
  ...
  const faqs = [
    ...
    { q: "Où sont hébergées mes données ?", a: "En France, sur des serveurs certifiés. RGPD Express est intégralement conforme au RGPD, avec chiffrement de bout en bout et une architecture privacy by design. Aucun transfert de données hors de l'Union européenne." },
  ];
  ...
  return (
    <div style={{ fontFamily: FB, background: "#fff", color: "#1e293b", overflowX: "hidden" }}>
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 56 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            {["Fonctionnalités", "Tarifs", "Témoignages", "FAQ"].map(l => (
              <a key={l} href={`#${l.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")}`} style={{ fontSize: 13, color: "#64748b", fontWeight: 500, textDecoration: "none", transition: "color 0.2s" }} onMouseEnter={e => e.target.style.color = "#0f172a"} onMouseLeave={e => e.target.style.color = "#64748b"}>{l}</a>
            ))}
      ...
      <section id="tarifs" style={{ padding: "70px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              { name: "Solo", price: "29", sub: "Indépendants et micro-entreprises", pop: false, feats: ["Audit de conformité complet", "Registre des traitements", "Politique de confidentialité", "Mentions légales et bannière", "Guide d'intégration illustré", "Accompagnement visio inclus"] },
              { name: "Équipe", price: "59", sub: "TPE et PME jusqu'à 50 salariés", pop: true, feats: ["L'offre Solo, complétée par :", "Accords sous-traitants (DPA)", "Veille réglementaire continue", "Formation et sensibilisation", "Gestion des droits des personnes", "Accompagnement dédié prioritaire"] },
            ].map((p, i) => (
              <Fade key={i} delay={i * 0.1}>
                <div style={{ background: "#fff", borderRadius: 18, padding: "32px 26px", border: p.pop ? "2px solid #2563eb" : "1.5px solid #e2e8f0", position: "relative", boxShadow: p.pop ? "0 8px 30px rgba(37,99,235,0.1)" : "none" }}>
                  ...
                  <a href={`mailto:${EMAIL}?subject=Souscription offre ${p.name}`} style={{
          ...
          <Fade delay={0.2}>
            ...
            <div style={{ textAlign: "center", marginTop: 8 }}>
              <span style={{ fontSize: 11, color: "#16a34a", fontWeight: 600 }}>🛡️ Garantie satisfait ou remboursé — 30 jours</span>
            </div>
      ...
      <section style={{ padding: "40px 24px" }}>
        <Fade>
          <div style={{ maxWidth: 700, margin: "0 auto", display: "flex", alignItems: "center", gap: 20, padding: "28px 28px", background: "#f0fdf4", borderRadius: 18, border: "1px solid #bbf7d0" }}>
            <div style={{ minWidth: 56, height: 56, borderRadius: "50%", background: "#dcfce7", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>🛡️</div>
            <div>
              <h3 style={{ fontSize: 16, fontWeight: 700, color: "#166534", margin: "0 0 4px" }}>Garantie satisfait ou remboursé — 30 jours</h3>
              <p style={{ fontSize: 12, color: "#16a34a", lineHeight: 1.5, margin: 0 }}>Si nos documents ne répondent pas à vos attentes, nous vous remboursons intégralement votre premier mois. Sans condition, sans justification. Nous assumons le risque à votre place.</p>
            </div>
          </div>
        </Fade>
      </section>
        ...
        <Fade>
          <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center", padding: "44px 32px", background: "#0f172a", borderRadius: 24, color: "#fff", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <p style={{ fontSize: 10, color: "#475569", marginTop: 16 }}>Garantie satisfait ou remboursé 30 jours · Sans engagement · Hébergé en France 🇫🇷</p>
            </div>
          </div>
        </Fade>
      </section>
      ...
      <footer style={{ borderTop: "1px solid #f1f5f9", padding: "32px 24px 28px", background: "#fafbfc" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid #e2e8f0", paddingTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <span style={{ fontSize: 11, color: "#94a3b8" }}>Hébergé en France 🇫🇷</span>
          </div>
        </div>
      </footer>
    </div>
