...
export default function App() {
  ...
  const faqs = [
    ...
    { q: "Où sont hébergées mes données ?", a: "RGPD Express est intégralement conforme au RGPD, avec chiffrement de bout en bout et une architecture privacy by design. Notre infrastructure repose sur des prestataires certifiés, conformes au Data Privacy Framework (accord UE-US). Les réponses au questionnaire d'audit rapide (8 questions) sont calculées localement dans votre navigateur et ne sont pas transmises à nos serveurs. Les réponses au questionnaire client complet (28 à 29 questions, après paiement) sont envoyées de manière sécurisée à notre serveur pour générer votre dossier personnalisé, puis supprimées après traitement." },
  ];
      ...
      <section style={{ padding: "60px 24px 70px", background: "#fafbfc" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="steps-grid" style={{ display: "grid", gap: 16 }}>
            {[
              { num: "01", title: "Vous répondez", desc: "Un questionnaire intelligent de 28 à 29 questions en 6 blocs. En langage courant, sans jargon. Durée : 20 minutes.", badge: "Sans compétence juridique" },
